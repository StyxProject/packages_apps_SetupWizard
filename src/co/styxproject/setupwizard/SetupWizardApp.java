...
import co.styxproject.setupwizard.util.NetworkMonitor;
import co.styxproject.setupwizard.util.PhoneMonitor;
...
public class SetupWizardApp extends Application {
    ...
    public static final String ACTION_SETUP_COMPLETE =
            "co.styxproject.setupwizard.LINEAGE_SETUP_COMPLETE";
    public static final String ACTION_FINISHED = "co.styxproject.setupwizard.SETUP_FINISHED";
